...
<div class="container">
    <div class="row justify-content-end">
          <div>  
            ...
            document.getElementById('notation_form_add').submit();" class='marker' data-toggle="tooltip" data-placement="bottom" width=20 title='Добавить запись' alt='Добавить запись' src="{{ asset('img/icons/add.png') }}">
         </div>
    </div>

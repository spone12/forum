                ...
                <div class="chatLs__chat">
                    <div class='col-sm-12 row'>
                        <div class='col-lg-2 col-xl-1 col-sm-2 col-md-2'>
                            <a class='chatLs__link' target='_blank' href='/profile/{{$chat->id}}'>
                                <img class='chatLs__photo' src="{{ asset($chat->avatar) }}" /> 
                            </a>
                        </div>
                        <div class='col-lg-8 col-xl-8 col-sm-6 col-md-6 chatLs__text'>{{$chat->text}}</div>
                        <div class='chatLs__move col-lg-1 col-sm-2 col-md-1 align-items-center justify-content-end d-flex'>
                        ...
                        <div class='col-lg-1 col-sm-2 col-md-2 chatLs__date align-items-center justify-content-start d-flex'>
    ...
    <div class="row MessageBlock justify-content-center align-items-center">
        <div class='col-10'>
            <div class="row no-gutters dialog">
                <a href='/chat/' class='MessageBlock__back justify-content-center row col-1 col-sm-2'>
